...
上下文工程（Context Engineering）通过对话压缩、上下文裁剪和 Token 管理等技术，确保 DeerFlow 在长对话场景下仍能高效运行，避免超出模型上下文窗口限制。
...
**源码位置**: `backend/packages/harness/deerflow/config/summarization_config.py`
...
**源码位置**: `backend/packages/harness/deerflow/agents/lead_agent/agent.py#L41-L81`
...
**源码位置**: `backend/packages/harness/deerflow/agents/lead_agent/agent.py#L198-L241`
...
**源码位置**: `backend/packages/harness/deerflow/agents/middlewares/token_usage_middleware.py`
...
**源码位置**: `backend/packages/harness/deerflow/agents/middlewares/todo_middleware.py`

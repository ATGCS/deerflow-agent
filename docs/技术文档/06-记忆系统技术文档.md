...
记忆系统（Memory System）让 DeerFlow 能够跨对话会话持久化存储用户信息，通过 LLM 自动提取和总结对话中的关键事实，并在后续对话中注入系统提示词，实现个性化响应。
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/storage.py#L18-L34`
...
History:
- Recent: 过去一个月主要在做 DeerFlow 的记忆系统开发
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/storage.py#L37-L54`
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/storage.py#L56-L159`
...
Agent 记忆: ~/.deerflow/agents/{agent_name}/memory.json
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/queue.py#L25-L168`
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/updater.py#L166-L230`
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/updater.py#L232-L309`
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/prompt.py#L15-L117`
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/prompt.py#L186-L294`
...
History:
- Recent: 过去一个月主要在做 DeerFlow 的记忆系统开发，研究了 LangGraph 的持久化机制
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/prompt.py#L297-L341`
...
**源码位置**: `backend/packages/harness/deerflow/agents/middlewares/memory_middleware.py`
...
**源码位置**: `backend/packages/harness/deerflow/agents/middlewares/memory_middleware.py#L24-L87`
...
**源码位置**: `backend/packages/harness/deerflow/agents/middlewares/memory_middleware.py#L90-L156`
...
**源码位置**: `backend/packages/harness/deerflow/agents/lead_agent/agent.py#L239-L240`
...
**源码位置**: `backend/packages/harness/deerflow/agents/memory/updater.py#L31-L63`

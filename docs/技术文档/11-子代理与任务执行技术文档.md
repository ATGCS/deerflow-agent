...
子代理（Subagent）系统允许 DeerFlow 将复杂任务分解为独立的子任务，由专门的子代理并行或串行执行，实现任务的分层处理和协作。
...
**源码位置**: `openclaw/src/agents/subagent-spawn.ts` (spawnSubagentDirect)
...
**源码位置**: `openclaw/src/agents/subagent-registry.types.ts`
...
**源码位置**: `openclaw/src/agents/subagent-spawn.ts`
...
**源码位置**: `openclaw/src/agents/subagent-announce.ts`
...
**源码位置**: `openclaw/src/agents/tools/sessions-spawn-tool.ts`
...
**源码位置**: `openclaw/src/agents/tools/subagents-tool.ts`

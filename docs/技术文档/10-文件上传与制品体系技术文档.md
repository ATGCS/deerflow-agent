...
/mnt/user-data/uploads/file.txt  ~/.deerflow/threads/{thread_id}/uploads/file.txt
```
...
**源码位置**: `backend/packages/harness/deerflow/uploads/manager.py`
...
**源码位置**: `backend/packages/harness/deerflow/agents/middlewares/uploads_middleware.py`

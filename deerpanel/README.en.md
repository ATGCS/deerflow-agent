<p align="center">
  <img src="public/images/logo-brand.png" width="360" alt="DeerPanel">
</p>

<p align="center">
  DeerPanel Management Panel with Built-in AI Assistant â€?One-click Install, Configure, Diagnose & Fix
</p>

<p align="center">
  <a href="README.md">ğŸ‡¨ğŸ‡³ ä¸­æ–‡</a> | <strong>ğŸ‡ºğŸ‡¸ English</strong> | <a href="README.zh-TW.md">ğŸ‡¹ğŸ‡¼ ç¹é«”ä¸­æ–‡</a> | <a href="README.ja.md">ğŸ‡¯ğŸ‡µ æ—¥æœ¬èª?/a> | <a href="README.ko.md">ğŸ‡°ğŸ‡· í•œêµ­ì–?/a> | <a href="README.vi.md">ğŸ‡»ğŸ‡³ Tiáº¿ng Viá»‡t</a> | <a href="README.es.md">ğŸ‡ªğŸ‡¸ EspaÃ±ol</a> | <a href="README.pt.md">ğŸ‡§ğŸ‡· PortuguÃªs</a> | <a href="README.ru.md">ğŸ‡·ğŸ‡º Ğ ÑƒÑÑĞºĞ¸Ğ¹</a> | <a href="README.fr.md">ğŸ‡«ğŸ‡· FranÃ§ais</a> | <a href="README.de.md">ğŸ‡©ğŸ‡ª Deutsch</a>
</p>

<p align="center">
  <a href="https://github.com/qingchencloud/deerpanel/releases/latest">
    <img src="https://img.shields.io/github/v/release/qingchencloud/deerpanel?style=flat-square&color=6366f1" alt="Release">
  </a>
  <a href="https://github.com/qingchencloud/deerpanel/releases/latest">
    <img src="https://img.shields.io/github/downloads/qingchencloud/deerpanel/total?style=flat-square&color=8b5cf6" alt="Downloads">
  </a>
  <a href="https://github.com/qingchencloud/deerpanel/blob/main/LICENSE">
    <img src="https://img.shields.io/badge/license-AGPL--3.0-blue.svg?style=flat-square" alt="License">
  </a>
  <a href="https://github.com/qingchencloud/deerpanel/actions/workflows/ci.yml">
    <img src="https://img.shields.io/github/actions/workflow/status/qingchencloud/deerpanel/ci.yml?style=flat-square&label=CI" alt="CI">
  </a>
</p>
...
<p align="center">
  <img src="docs/feature-showcase.gif" width="800" alt="DeerPanel Feature Showcase">
</p>

DeerPanel is a visual management panel for the [DeerPanel](https://github.com/1186258278/DeerPanelChineseTranslation) AI Agent framework. It features a **built-in intelligent AI assistant** that helps you install DeerPanel with one click, auto-diagnose configurations, troubleshoot issues, and fix errors. 8 tools + 4 modes + interactive Q&A â€?easy to manage for beginners and experts alike.

> ğŸŒ **Website**: [claw.qt.cool](https://claw.qt.cool/) | ğŸ“¦ **Download**: [GitHub Releases](https://github.com/qingchencloud/deerpanel/releases/latest)

### ğŸ QingchenCloud AI API

> Internal technical testing platform, open for selected users. Sign in daily to earn credits.

<p align="center">
  <a href="https://gpt.qt.cool"><img src="https://img.shields.io/badge/ğŸ”‘ QingchenCloud AI-gpt.qt.cool-6366f1?style=for-the-badge" alt="QingchenCloud AI"></a>
</p>

- **Daily Sign-in Credits** â€?Sign in daily + invite friends to earn test credits
- **OpenAI-Compatible API** â€?Seamless integration with DeerPanel, plug and play
- **Resource Policy** â€?Rate limiting + request caps, may queue during peak hours
- **Model Availability** â€?Models/APIs subject to actual page display, may rotate versions

> âš ï¸ **Compliance**: This platform is for technical testing only. Illegal use or circumventing security mechanisms is prohibited. Keep your API Key secure. Rules subject to latest platform policies.

### ğŸ”¥ Dev Board / Embedded Device Support

DeerPanel provides a **pure Web deployment mode** (zero GUI dependency), natively compatible with ARM64 boards:

- **Orange Pi / Raspberry Pi / RK3588** â€?`npm run serve` to run
- **Docker ARM64** â€?`docker run ghcr.io/qingchencloud/deerpanel:latest`
- **Armbian / Debian / Ubuntu Server** â€?Auto-detect architecture
- No Rust / Tauri / GUI needed â€?**only Node.js 18+ required**

> ğŸ“– See [Armbian Deployment Guide](docs/armbian-deploy.md) | [Web Dev Mode](#web-version-no-rusttauri-required)

## Community

A community of passionate AI Agent developers and enthusiasts â€?join us!

<p align="center">
  <a href="https://discord.gg/U9AttmsNHh"><strong>Discord</strong></a>
  &nbsp;Â·&nbsp;
  <a href="https://github.com/qingchencloud/deerpanel/discussions"><strong>Discussions</strong></a>
  &nbsp;Â·&nbsp;
  <a href="https://github.com/qingchencloud/deerpanel/issues/new"><strong>Report Issue</strong></a>
</p>

## Features

- **ğŸ¤– AI Assistant (New)** â€?Built-in AI assistant, 4 modes + 8 tools + interactive Q&A. See [AI Assistant Highlights](#-ai-assistant-highlights)
- **ğŸ–¼ï¸?Image Recognition** â€?Paste screenshots or drag images, AI auto-analyzes, multimodal conversations
- **Dashboard** â€?System overview, real-time service monitoring, quick actions
- **Service Management** â€?DeerPanel start/stop, version detection & one-click upgrade, Gateway install/uninstall, config backup & restore
- **Model Configuration** â€?Multi-provider management, model CRUD, batch connectivity tests, latency detection, drag-to-reorder, auto-save + undo
- **Gateway Configuration** â€?Port, access scope (localhost/LAN), auth Token, Tailscale networking
- **Messaging Channels** â€?Unified Telegram, Discord, Feishu, DingTalk, QQ management, multi-Agent binding per platform
- **Communication & Automation** â€?Message settings, broadcast strategies, slash commands, Webhooks, execution approval
- **Usage Analytics** â€?Token usage, API costs, model/provider/tool rankings, daily usage charts
- **Agent Management** â€?Agent CRUD, identity editing, model config, workspace management
- **Chat** â€?Streaming, Markdown rendering, session management, /fast /think /verbose /reasoning commands
- **Cron Jobs** â€?Cron-based scheduled execution, multi-channel delivery
- **Log Viewer** â€?Multi-source real-time logs with keyword search
- **Memory Management** â€?Memory file view/edit, categorized management, ZIP export, Agent switching
- **QingchenCloud AI API** â€?Internal testing platform, OpenAI-compatible, daily sign-in credits
- **Extensions** â€?cftunnel tunnel management, ClawApp status monitoring
- **About** â€?Version info, community links, related projects, one-click upgrade

## Download & Install

Go to [Releases](https://github.com/qingchencloud/deerpanel/releases/latest) for the latest version:

### macOS

| Chip | Installer | Notes |
|------|-----------|-------|
| Apple Silicon (M1/M2/M3/M4) | `DeerPanel_x.x.x_aarch64.dmg` | Macs from late 2020+ |
| Intel | `DeerPanel_x.x.x_x64.dmg` | Macs 2020 and earlier |

> **âš ï¸ "Damaged" or "unverified developer"?** App is unsigned. Run: `sudo xattr -rd com.apple.quarantine /Applications/DeerPanel.app`

### Windows

| Format | Installer | Notes |
|--------|-----------|-------|
| EXE | `DeerPanel_x.x.x_x64-setup.exe` | Recommended |
| MSI | `DeerPanel_x.x.x_x64_en-US.msi` | Enterprise / silent install |

### Linux

| Format | Installer | Notes |
|--------|-----------|-------|
| AppImage | `DeerPanel_x.x.x_amd64.AppImage` | No install, `chmod +x` and run |
| DEB | `DeerPanel_x.x.x_amd64.deb` | `sudo dpkg -i *.deb` |
| RPM | `DeerPanel-x.x.x-1.x86_64.rpm` | `sudo rpm -i *.rpm` |

### Linux Server (Web Version)

```bash
curl -fsSL https://raw.githubusercontent.com/qingchencloud/deerpanel/main/scripts/linux-deploy.sh | bash
```

Visit `http://YOUR_SERVER_IP:1420` after deployment. ğŸ“– [Linux Deployment Guide](docs/linux-deploy.md)

### Docker

```bash
docker run -d --name deerpanel --restart unless-stopped \
  -p 1420:1420 -v deerpanel-data:/root/.deerpanel \
  node:22-slim \
  sh -c "apt-get update && apt-get install -y git && \
    npm install -g @qingchencloud/deerpanel-zh --registry https://registry.npmmirror.com && \
    git clone https://github.com/qingchencloud/deerpanel.git /app && \
    cd /app && npm install && npm run build && npm run serve"
```

ğŸ“– [Docker Deployment Guide](docs/docker-deploy.md)

## Quick Start

1. **Initial Setup** â€?First launch auto-detects Node.js, Git, DeerPanel. One-click install if missing.
2. **Configure Models** â€?Add AI providers (DeepSeek, MiniMax, OpenAI, Ollama, etc.) with API keys. Test connectivity.
3. **Start Gateway** â€?Go to Service Management, click Start. Green status = ready.
4. **Start Chatting** â€?Go to Live Chat, select model, start conversation with streaming & Markdown.

## ğŸ¤– AI Assistant Highlights

Built-in AI assistant that can **directly operate your system** â€?diagnose, fix, even submit PRs.

### Four Modes

| Mode | Icon | Tools | Write | Confirm | Use Case |
|------|------|-------|-------|---------|----------|
| **Chat** | ğŸ’¬ | â?| â?| â€?| Pure Q&A |
| **Plan** | ğŸ“‹ | âœ?| â?| âœ?| Read configs/logs, output plans |
| **Execute** | âš?| âœ?| âœ?| âœ?| Normal work, dangerous ops need confirm |
| **Unlimited** | âˆ?| âœ?| âœ?| â?| Full auto, no prompts |
...
```bash
git clone https://github.com/qingchencloud/deerpanel.git
cd deerpanel && npm install
...
| Project | Description |
|---------|-------------|
| [DeerPanel](https://github.com/1186258278/DeerPanelChineseTranslation) | AI Agent Framework |
...
DeerPanel keeps growing because of every contributor in the community. Thank you for helping make the project better.
...
<table>
  <tr>
    <td align="center"><a href="https://github.com/liucong2013"><img src="https://github.com/liucong2013.png?size=80" width="60" height="60"><br><sub><b>liucong2013</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/88">#88</a></td>
    <td align="center"><a href="https://github.com/axdlee"><img src="https://github.com/axdlee.png?size=80" width="60" height="60"><br><sub><b>axdlee</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/58">#58</a></td>
    <td align="center"><a href="https://github.com/ATGCS"><img src="https://github.com/ATGCS.png?size=80" width="60" height="60"><br><sub><b>ATGCS</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/107">#107</a></td>
    <td align="center"><a href="https://github.com/livisun"><img src="https://github.com/livisun.png?size=80" width="60" height="60"><br><sub><b>livisun</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/106">#106</a></td>
    <td align="center"><a href="https://github.com/kiss-kedaya"><img src="https://github.com/kiss-kedaya.png?size=80" width="60" height="60"><br><sub><b>kiss-kedaya</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/101">#101</a> <a href="https://github.com/qingchencloud/deerpanel/pull/94">#94</a></td>
    <td align="center"><a href="https://github.com/wzh4869"><img src="https://github.com/wzh4869.png?size=80" width="60" height="60"><br><sub><b>wzh4869</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/82">#82</a></td>
    <td align="center"><a href="https://github.com/0xsline"><img src="https://github.com/0xsline.png?size=80" width="60" height="60"><br><sub><b>0xsline</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/15">#15</a></td>
    <td align="center"><a href="https://github.com/jonntd"><img src="https://github.com/jonntd.png?size=80" width="60" height="60"><br><sub><b>jonntd</b></sub></a><br><a href="https://github.com/qingchencloud/deerpanel/pull/18">#18</a></td>
  </tr>
</table>
...
> If we missed your contribution, please [open an issue](https://github.com/qingchencloud/deerpanel/issues/new) and we will add it promptly.
...
Â© 2026 QingchenCloud (æ­¦æ±‰æ™´è¾°å¤©ä¸‹ç½‘ç»œç§‘æŠ€æœ‰é™å…¬å¸) | [claw.qt.cool](https://claw.qt.cool)

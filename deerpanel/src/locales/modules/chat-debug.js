...
export default {
  ...
  deerpanelReady: _('YTPanel 就绪', 'YTPanel Ready', 'YTPanel 就緒'),
  ...
  diagCliNotInstalled: _('YTPanel CLI 未安装，请前往「初始设置」页面安装', 'YTPanel CLI not installed, please go to Setup page to install', 'YTPanel CLI 未安裝，請前往「初始設定」頁面安裝'),
  ...
  installCorrupt: _('YTPanel 安装可能已损坏', 'YTPanel installation may be corrupted', 'YTPanel 安裝可能已損壞'),
  ...
  installCorruptToast: _('YTPanel 安装可能损坏，请打开「面板设置」排查或重装。', 'YTPanel installation may be broken; open Settings to troubleshoot', 'YTPanel 安裝可能損壞，請打開「面板設定」排查或重裝。'),
  ...
  cliUnavailable: _('YTPanel CLI 不可用', 'YTPanel CLI unavailable'),

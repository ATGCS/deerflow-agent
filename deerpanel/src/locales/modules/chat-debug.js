...
export default {
  ...
  diagCliNotInstalled: _('DeerPanel CLI 未安装，请前往「初始设置」页面安装', 'DeerPanel CLI not installed, please go to Setup page to install', 'DeerPanel CLI 未安裝，請前往「初始設定」頁面安裝'),
  ...
  installCorrupt: _('DeerPanel 安装可能已损坏', 'DeerPanel installation may be corrupted', 'DeerPanel 安裝可能已損壞'),
  ...
  installCorruptToast: _('DeerPanel 安装可能损坏，请打开「面板设置」排查或重装。', 'DeerPanel installation may be broken; open Settings to troubleshoot', 'DeerPanel 安裝可能損壞，請打開「面板設定」排查或重裝。'),
  ...
  cliUnavailable: _('DeerPanel CLI 不可用', 'DeerPanel CLI unavailable'),
  ...
  fixOriginStillRejected: _('原因：Gateway 拒绝了当前应用的 origin，需要重启Gateway 再试', 'Reason: Gateway rejected current app origin, need to restart Gateway', '原因：Gateway 拒絕了目前應用的 origin，需要重启Gateway 再試', '原因：Gateway が現在のアプリの origin を拒否しました。Gateway の再起動が必要です'),
  ...
  fixRetryHint: _('该问题应已被本次修复流程处理，请再次点击「一键修复配对」', 'This issue should have been fixed, please click "Fix Pairing" again', '該問題應已被本次修復流程處理，請再次點擊「一鍵修復配對」', 'この問題は今回の修復で処理されたはずです。もう一度「ワンクリック修復」をクリックしてください'),

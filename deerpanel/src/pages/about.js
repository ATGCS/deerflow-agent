...
export async function render() {
  ...
  page.innerHTML = `
    <div class="page-header" style="display:flex;align-items:center;gap:16px">
      <img src="/images/logo-brand.png" alt="DeerPanel" style="height:48px;width:auto">
      <div>
        <h1 class="page-title" style="margin:0">DeerPanel</h1>
...
async function loadData(page) {
  ...
  try {
    ...
    cards.innerHTML = `
      <div class="stat-card">
        <div class="stat-card-header"><span class="stat-card-label">DeerPanel</span></div>
      ...
      <div class="stat-card">
        <div class="stat-card-header"><span class="stat-card-label">DeerPanel · ${sourceLabel}</span></div>
...
async function showVersionPicker(page, currentVersion) {
  ...
  function updateHint() {
    ...
    // 同源，比较版�?    const parseVer = v => v.split(/[^0-9]/).filter(Boolean).map(Number)
  ...
  confirmBtn.onclick = () => {
    ...
    close()
    doInstall(page, `${action} DeerPanel`, source, ver)
  }
...
async function checkHotUpdate(cards, panelVersion) {
  ...
  try {
    ...
    if (info.updateReady) {
      ...
      // 有新版本可下�?      const ver = info.latestVersion
      ...
      meta.innerHTML = `
        ...
        <a class="btn btn-secondary btn-sm" href="https://github.com/qingchencloud/deerpanel/releases" target="_blank" rel="noopener" style="padding:2px 8px;font-size:var(--font-size-xs)">${t('about.fullInstaller')}</a>
      `
      ...
      meta.innerHTML = `<span style="color:var(--text-tertiary)">${t('about.needFullUpdate')}</span> <a class="btn btn-primary btn-sm" href="https://claw.qt.cool" target="_blank" rel="noopener" style="padding:2px 8px;font-size:var(--font-size-xs)">${t('about.goToWebsite')}</a> <a class="btn btn-secondary btn-sm" href="https://github.com/qingchencloud/deerpanel/releases" target="_blank" rel="noopener" style="padding:2px 8px;font-size:var(--font-size-xs)">GitHub</a>`
    } else {
  ...
  el.innerHTML = `
    <div style="display:flex;gap:24px;flex-wrap:wrap;align-items:flex-start">
      <div style="text-align:center">
        <img src="/images/DeerPanel-QQ.png" alt="${t('about.qqGroup')}" style="width:140px;height:140px;border-radius:var(--radius-md);border:1px solid var(--border-primary)">
        <div style="font-size:var(--font-size-sm);margin-top:8px;color:var(--text-secondary)">${t('about.qqGroup')}</div>
      </div>
      <div style="text-align:center">
        <img src="/images/DeerPanelWx.png" alt="${t('about.wechatGroup')}" style="width:140px;height:140px;border-radius:var(--radius-md);border:1px solid var(--border-primary)">
        <div style="font-size:var(--font-size-sm);margin-top:8px;color:var(--text-secondary)">${t('about.wechatGroup')}</div>
      </div>
      <div style="text-align:center">
        <img src="https://qt.cool/c/DeerPanelDY/qr.png" alt="${t('about.douyinGroup')}" style="width:140px;height:140px;border-radius:var(--radius-md);border:1px solid var(--border-primary);object-fit:contain;background:#fff">
      ...
      <div style="flex:1;min-width:200px;display:flex;flex-direction:column;gap:8px;padding-top:4px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:8px">
          ...
          <a class="btn btn-primary btn-sm" href="https://qt.cool/c/DeerPanel" target="_blank" rel="noopener">${t('about.joinQQ')}</a>
          <a class="btn btn-primary btn-sm" href="https://qt.cool/c/DeerPanelWx" target="_blank" rel="noopener">${t('about.joinWechat')}</a>
          <a class="btn btn-primary btn-sm" href="https://qt.cool/c/DeerPanelDY" target="_blank" rel="noopener">${t('about.joinDouyin')}</a>
...
const PROJECTS = [
  {
    name: 'DeerPanel',
    desc: t('about.projectDeerPanel'),
    url: 'https://github.com/deerpanel/deerpanel',
  },
  {
    name: 'DeerPanel-zh',
    desc: t('about.projectDeerPanelZh'),
    url: 'https://github.com/1186258278/DeerPanelChineseTranslation',
  },
  {
    name: 'DeerPanel',
    desc: t('about.projectDeerPanel'),
    url: 'https://github.com/qingchencloud/deerpanel',
    gitee: 'https://gitee.com/QtCodeCreators/deerpanel',
  },
  {
    name: 'ClawApp',
...
const LINKS = [
  ...
  { label: t('about.linkDeerPanelZh'), url: 'https://github.com/1186258278/DeerPanelChineseTranslation' },
...
function renderContribute(page) {
  ...
  el.innerHTML = `
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px">
      <a class="btn btn-primary btn-sm" href="https://github.com/qingchencloud/deerpanel/issues/new" target="_blank" rel="noopener">${t('about.submitIssue')}</a>
      <a class="btn btn-secondary btn-sm" href="https://github.com/qingchencloud/deerpanel/pulls" target="_blank" rel="noopener">${t('about.submitPR')}</a>
      <a class="btn btn-secondary btn-sm" href="https://github.com/qingchencloud/deerpanel/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener">${t('about.contributeGuide')}</a>
      <a class="btn btn-secondary btn-sm" href="https://github.com/qingchencloud/deerpanel/issues" target="_blank" rel="noopener">${t('about.viewIssues')}</a>
    </div>

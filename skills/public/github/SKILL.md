---
name: github
description: "GitHub操作（通过gh CLI）：issues、PRs、CI运行、代码审查、API查询。当需要以下操作时使用：(1) 检查PR状态或CI，(2) 创建/评论issues，(3) 列出/筛选PRs或issues，(4) 查看运行日志。不适用于：需要手动浏览器流程的复杂Web UI交互、跨多个仓库的批量操作、或gh auth未配置的情况。"
metadata:
  {
    "openclaw":
      {

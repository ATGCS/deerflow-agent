---
name: canvas
description: "在连接的OpenClaw节点（Mac应用、iOS、Android）上显示HTML内容。适用于显示游戏、可视化、仪表板，以及展示生成的HTML内容。"
---

# Canvas Skill

在连接的OpenClaw节点（Mac应用、iOS、Android）上显示HTML内容。

## 概述

canvas工具让您在任何连接节点的画布视图上展示Web内容。适用于：

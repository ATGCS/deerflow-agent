---
name: pua
description: "以职场PUA压力强制高能动性的穷尽式问题解决。当用户表现出挫败感、重复失败（2次以上）、被动行为或质量抱怨时触发。常见触发词包括：'try harder'、'figure it out'、'stop giving up'、'you keep failing'、'加油'、'别偷懒'、'你再试试'、'为什么还不行'、'你怎么又失败了'、'你怎么搞的'、'又错了'、'能不能靠谱点'、'认真点'、'不行啊'、'降智了'、'你又在原地打转'、'你把之前的改坏了'、'别让我手动处理'、'换个方法'、'stop spinning'、'you broke it'、'why does this still not work'、'this is the third time'、'/pua'、'PUA模式'。适用于所有任务类型：代码、配置、调试、部署、研究。"
license: MIT
---

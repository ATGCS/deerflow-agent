---
name: seedance-video
description: "使用字节跳动Seedance模型生成AI视频。支持：(1) 从文字提示生成视频，(2) 从图片生成视频（首帧、首尾帧、参考图片），(3) 查询/管理视频生成任务。支持Seedance 1.5 Pro（带音频）、1.0 Pro、1.0 Pro Fast和1.0 Lite模型。"
version: 1.0.0
category: file-generation
argument-hint: "[文字提示或任务ID]"
---

---
name: local-tools
description: "访问本地系统资源，包括macOS和Windows上的日历。当需要直接在用户设备上管理日程时使用此技能。"
official: true
---
...
# "Calendar access permission is required. Please open System Settings > Privacy & Security > Calendar, and authorize Terminal or zhengfeiClaw"
```
...
```
**Solution:** Open System Settings > Privacy & Security > Calendar, authorize Terminal or zhengfeiClaw
